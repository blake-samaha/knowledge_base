...
Master foundational prompting styles that form the building blocks of effective
AI-assisted development.

## 🎯 Foundational Techniques

These core techniques provide the foundation for all advanced prompting. Master
these before moving to sophisticated methods.
...
**What it is**: Providing 1-5 input-output examples to demonstrate the desired
pattern
...
|------|----------|--------------|----------------| | Generic Developer | Basic
coding | 71% | Medium | | CDF Expert | CDF-specific tasks | 89% | High | |
...
**What it is**: Having multiple expert personas work together on a complex
problem
...
**Too vague** | "Create a data pipeline" | "Create a CDF transformation that
ingests SAP work orders daily" | | **Missing constraints** | "Process the data
quickly" | "Process within 5 minutes for 100K records" | | **Unclear output** |
"Return the results" | "Return JSON with asset_id, metric_value, timestamp" | |
**No error handling** | "Calculate the metrics" | "Calculate metrics, handle
NULLs, log failures" |
...
1. Review the output for gaps or issues
1. Refine the prompt to address problems
...
**Iteration 3**: "Create a robust CDF asset search with pagination, filtering,
...
| Task Type | Recommended Technique | CDF Example | Success Rate | Time to
Result |
|-----------|----------------------|-------------|--------------|----------------|
| **Basic asset creation** | Zero-shot | "Create pump asset" | 72% | Fast (1
try) | | **Pattern matching** | Few-shot | "Follow our naming convention" | 86%
| Fast (1-2 tries) | | **Complex transformations** | Structured + Role | "Design
MTBF calculation" | 91% | Medium (2-3 tries) | | **Security implementation** |
Role + Examples | "Secure API client" | 89% | Medium (2-3 tries) | |
**Performance optimization** | Iterative + Role | "Optimize for 1M records" |
93% | Slow (3-5 tries) | | **Novel solutions** | Iterative refinement | "New
data model approach" | 87% | Slow (4-6 tries) |

### 🎯 Quick Decision Rules

1. **Is it a standard CDF operation?** → Zero-shot
1. **Do you have good examples?** → Few-shot
1. **Need expertise?** → Add role prompting
1. **Complex requirements?** → Use structured format
1. **Exploring options?** → Iterative refinement
...
|-----------|----------|---------|----------|----------| | **Clarity** | Vague,
ambiguous | Somewhat clear | Mostly clear | Crystal clear | | **Specificity** |
No details | Some details | Good details | Complete specs | | **Context** | None
provided | Minimal | Adequate | Comprehensive | | **Examples** | None | Poor
quality | Good examples | Excellent examples | | **Structure** | Chaotic | Some
structure | Well organized | Perfectly structured | | **Constraints** | Not
mentioned | Few specified | Most specified | All specified | | **Success
Criteria** | None | Implicit | Some explicit | All explicit |
...
**C**ontext: Provide necessary background **L**anguage: Use precise terminology
**E**xamples: Include when helpful **A**ctions: Specify exact steps **R**esults:
...
- **[Context Engineering](context_engineering.md)** - Learn to provide effective
  context
- **[Advanced Prompting](advanced_prompting.md)** - Master sophisticated
  reasoning techniques
- **[AI Workflows](ai_workflows/index.md)** - Apply techniques in real-world
  scenarios
...
1. **Document Wins**: Save successful prompts for reuse
1. **Share Learning**: Team knowledge compounds
1. **Measure Progress**: Track improvement metrics
1. **Stay Curious**: New techniques emerge regularly

______________________________________________________________________

**Ready to level up?** Master these foundations, then move to
**[Context Engineering](context_engineering.md)** to multiply your effectiveness
10x.
