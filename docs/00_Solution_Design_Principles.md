...
The following three fully-populated examples illustrate how to complete this
template for different industries. **Copy & adapt** the sections as needed.
...
- **Business Goal:** Improve production efficiency by 5% through real-time
  visibility of well KPIs.
- **Primary Use Cases:**
...
*(Provide similar filled sections tailored to a manufacturing plant with CNC
machines)*
...
*(Provide similar filled sections tailored to a power-grid asset hierarchy &
SCADA data)*
